<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-100">
    ...
    <div class="max-w-8xl mx-auto px-0">
        <div class="flex justify-between h-20">
            <div class="flex w-72 bg-yellow-50">
                <img class="w-2/6" src="images/dsc-logo-cropped.jpg" alt="">
                <img class="w-4/6" src="images/sasmec-iium-logo.png" alt="">
            </div>

            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ml-6 px-4 sm:px-6 lg:px-8">
