        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span class="text-base font-semibold">{{ $clinic->issue }}</span>
              </td>
              ...
              <td class="px-6 py-1 whitespace-nowrap">
                ...
                @if($clinic->received_by == NULL)
                <span class="text-base font-semibold">No SCU assigned</span>
                @else
                <span class="text-base font-semibold">{{ $clinic->received_by }}</span>
                @endif
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button class="bg-indigo-200 hover:bg-indigo-300 text-indigo-600 hover:text-indigo-900 font-bold py-1 px-2 rounded inline-flex items-center">
                    ...
                    <a href="{{ url('clinic/assign-staff/'.$clinic->id) }}" class="px-2 items-center text-indigo-600 hover:text-indigo-900">View</a>
                </button>
              </td>
            </tr>
