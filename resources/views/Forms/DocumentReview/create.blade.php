...
@section('content')
      ...
      <div class="justify-center">
        <p class="text-lg font-bold p-2">Document Review Submission</p>

      <div x-data="app()" class="w-full mx-auto rounded-xl" x-cloak>
        <div class="w-full mx-auto shadow-2xl rounded-x px-4 py-6">
          ...
          <div x-show.transition="step != 'complete'">	
            ...
            <div class="w-full border-b-2 px-8 py-4">
              ...
              <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="flex-1">
                  <div x-show="step === 1">
                    <div class="text-lg font-bold text-gray-700 leading-tight">Document Submission</div>
                  </div>
            ...
            <form action="{{ route('document-review.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="overflow-hidden sm:rounded-md">
                      ...
                      <div x-show.transition.in="step === 1">
                        <div class="grid grid-cols-10 gap-6">
                          <div class="col-span-6 sm:col-span-5">
                            <label for="document_name" class="font-semibold leading-none">Document name</label>
                            <input type="text" name="document_name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required="">
                                @error('document_name')
                    ...
                    <div class="w-full flex flex-col">
                        <label class="font-semibold leading-none">Upload your document here</label>
                            <!-- file upload modal -->
                            ...
                            <section class="h-full overflow-auto p-8 w-full h-full flex flex-col">
                                ...
                                <input id="hidden-input" type="file" name="document_file" multiple class="hidden" />
